...
const PAGE_BACKGROUND_STYLE: React.CSSProperties = {
  ...
  backgroundImage: `
    ...
    linear-gradient(90deg, rgba(35,136,255,0.03) 0%, #ffffff 50%, rgba(35,136,255,0.03) 100%),
    linear-gradient(180deg, rgba(35,136,255,0.05) 0%, #ffffff 100%)
  `,
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          className={
            'dark:bg-background flex min-w-0 flex-1 flex-col px-4 lg:px-0'
          }
...
function PageWithHeader(props: PageProps) {
  ...
  return (
    <div
      className={cn(
        'dark:bg-background flex h-screen flex-1 flex-col',
        props.className,
      )}
      style={PAGE_BACKGROUND_STYLE}
    >
...
export function PageBody(
  ...
  const className = cn('flex min-w-0 flex-1 flex-col lg:p-4', props.className);
...
export function PageHeader({
  ...
  return (
    <div
      className={cn(
        'flex items-center justify-between py-5 lg:border-b lg:px-4 lg:pb-4',
        className,
      )}
    >
      ...
      <div className="flex items-center gap-x-4">
        <If condition={trailing}>
          <div className="hidden lg:block">{trailing}</div>
        </If>
        {children}
      </div>
    </div>
