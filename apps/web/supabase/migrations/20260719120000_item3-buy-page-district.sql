-- ─────────────────────────────────────────────────────────────────────────────
-- Item 3 / ledger #19 — district headline data on the buy-page RPCs.
--
-- The purchase header picks its headline by campus flag: a campus-flagged
-- district is the headline (its logo + name + goal), with the chapter shown
-- smaller underneath; otherwise the org is the headline. Both buy-page RPCs now
-- return the org's district identity so the header can make that choice. The
-- district's goal numbers come separately from get_campus_leaderboard_summary
-- (already net, ledger #20). Signatures change → drop+create.
-- ─────────────────────────────────────────────────────────────────────────────
