...
interface MerchantsFilterButtonProps {
  isOpen: boolean;
  onToggle: () => void;
  activeFilterCount: number;
}

export function MerchantsFilterButton({
  isOpen,
  onToggle,
  activeFilterCount,
}: MerchantsFilterButtonProps) {
  return (
    <Button
      variant="outline"
      className="gap-2"
      onClick={onToggle}
      data-test="merchants-filter-button"
    >
...
interface MerchantsFilterContentProps {
...
export function MerchantsFilterContent({
  filters,
  onStateChange,
  onCityChange,
  onClear,
}: MerchantsFilterContentProps) {
