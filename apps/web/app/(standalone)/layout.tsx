...
function StandaloneLayout({ children }: React.PropsWithChildren) {
  return (
    <div
    ...
    >
      <div className="bg-background flex w-full max-w-[760px] flex-col gap-y-6 rounded-lg px-6 py-6 shadow-lg md:px-8 md:py-8">
...
export default withI18n(StandaloneLayout);
