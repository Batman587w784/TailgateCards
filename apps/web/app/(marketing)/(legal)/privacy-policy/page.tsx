      ...
      <div className="container mx-auto max-w-4xl px-4 py-12">
        <article className="max-w-none space-y-16">
          ...
          <section className="space-y-4">
            ...
            <p className="text-muted-foreground leading-7">
              This Privacy Policy describes how Tailgate Systems, Inc., a
              Delaware corporation (&quot;Tailgate,&quot; &quot;Company,&quot;
              &quot;we,&quot; &quot;us,&quot; or &quot;our&quot;), collects,
              uses, processes, shares, and otherwise handles information
              relating to individuals who access or use Tailgate&apos;s cards,
              websites, applications, NFC-enabled services, QR-based access
              mechanisms, or other related products and services (collectively,
              the &quot;Platform&quot;).
            </p>

            <p className="text-muted-foreground leading-7">
              This Privacy Policy applies to all users, cardholders, visitors,
              and individuals who interact with the Platform in any manner
              within the United States. By accessing or using the Platform, you
              acknowledge that you have read and understood this Privacy Policy
              and consent to the practices described herein, subject to your
              rights under applicable law.
            </p>

            <p className="text-muted-foreground leading-7">
              This Privacy Policy is incorporated by reference into the Tailgate
              Terms of Service and should be read in conjunction with those
              Terms.
            </p>
          </section>
          ...
          <section className="space-y-4">
            ...
            <p className="text-muted-foreground leading-7">
              Tailgate collects information directly from you, automatically
              through your use of the Platform, and from third-party sources, to
              the maximum extent permitted by applicable law.
            </p>

            <p className="text-muted-foreground leading-7">
              Information you provide directly may include identifying
              information such as name, email address, phone number, school or
              organizational affiliation, demographic information such as age
              range or gender where voluntarily provided, and any other
              information you choose to submit through forms, communications, or
              account interactions.
            </p>

            <p className="text-muted-foreground leading-7">
              Information collected automatically may include device
              identifiers, IP address, browser type, operating system, network
              information, NFC and QR interaction data, timestamps, session
              duration, redemption history, usage frequency, interaction
              patterns, approximate or precise location data where enabled, and
              other technical or behavioral data associated with your use of the
              Platform.
            </p>

            <p className="text-muted-foreground leading-7">
              Tailgate may also generate inferred or derived data based on your
              activity, including preferences, behavioral characteristics,
              affinity categories, predicted interests, engagement scores, and
              other analytical insights.
            </p>
          </section>

          <section className="space-y-4">
            <h3 className="text-xl font-semibold">
              2. Demographic, Location, and Preference Data
            </h3>

            <p className="text-muted-foreground leading-7">
              To the extent permitted by law, Tailgate may collect, infer,
              derive, or otherwise process demographic and preference-based
              information, including but not limited to age ranges, gender
              identity, racial or ethnic identifiers where voluntarily provided
              or lawfully obtained, geographic location patterns, venue visit
              behavior, interests, purchasing tendencies, and inferred
              characteristics derived from Platform usage or third-party data
              sources.
            </p>

            <p className="text-muted-foreground leading-7">
              Such data may be associated with you directly, or used in
              anonymized, aggregated, or derived form to generate insights,
              segments, or analytical products.
            </p>
          </section>
          ...
          <section className="space-y-4">
            ...
            <p className="text-muted-foreground leading-7">
              Tailgate may obtain information about you from third-party
              sources, including analytics providers, advertising partners, data
              brokers, publicly available databases, social or marketing
              platforms (where permitted), and technology partners. This
              information may be combined with information collected directly or
              automatically to enrich user profiles, improve accuracy, and
              enhance analytical capabilities.
            </p>
          </section>

          <section className="space-y-4">
            <h3 className="text-xl font-semibold">4. How We Use Information</h3>

            <p className="text-muted-foreground leading-7">
              Tailgate uses information collected for a variety of business,
              operational, analytical, and commercial purposes. These purposes
              include operating and improving the Platform, enabling card
              functionality, facilitating access to merchant offers,
              communicating with users, providing customer support, monitoring
              performance, preventing fraud or misuse, conducting research and
              analytics, developing new products or features, personalizing
              experiences, and measuring engagement or effectiveness.
            </p>

            <p className="text-muted-foreground leading-7">
              Information may also be used for advertising, marketing, audience
              segmentation, preference modeling, predictive analytics,
              artificial intelligence and machine learning training, and other
              commercial uses consistent with Tailgate&apos;s role as a
              data-driven platform, to the maximum extent permitted by law.
            </p>
          </section>

          <section className="space-y-4">
            <h3 className="text-xl font-semibold">
              5. Data Commercialization and Redistribution
            </h3>

            <p className="text-muted-foreground leading-7">
              Subject to applicable law and valid opt-out rights, Tailgate may
              commercialize, license, sell, assign, share, or otherwise
              distribute data, including demographic, behavioral, location,
              preference, and derived data, to third parties such as
              advertisers, analytics providers, research partners, merchants,
              affiliates, or other commercial counterparties.
            </p>

            <p className="text-muted-foreground leading-7">
              Tailgate determines, in its discretion, the manner, format, and
              recipients of such data sharing or commercialization, including
              whether data is provided in identifiable, de-identified,
              anonymized, aggregated, or derived form. Users waive any right to
              compensation or approval for such uses, except as required by law.
            </p>
          </section>
          ...
          <section className="space-y-4">
            ...
            <p className="text-muted-foreground leading-7">
              Tailgate may aggregate, anonymize, or de-identify information such
              that it can no longer reasonably be used to identify an
              individual. Aggregated, anonymized, or derived data is not
              considered personal data under this Privacy Policy and may be
              retained, used, and commercialized indefinitely. Users have no
              ownership or control rights over such data.
            </p>
          </section>
          ...
          <section className="space-y-4">
            ...
            <p className="text-muted-foreground leading-7">
              Tailgate may use collected information to send promotional,
              transactional, and informational communications, including
              personalized messages based on user data. Communications may be
              delivered via email, SMS, push notifications, in-app messaging, or
              other channels.
            </p>

            <p className="text-muted-foreground leading-7">
              Users may opt out of certain marketing communications at any time
              using unsubscribe links, account settings, or by contacting
              Tailgate. Opting out of marketing communications does not limit
              Tailgate&apos;s ability to process data for other lawful purposes
          ...
          <section className="space-y-4">
            <h3 className="text-xl font-semibold">
              8. Merchant Participation and Limitation of Control
            </h3>

            <p className="text-muted-foreground leading-7">
              Tailgate facilitates access to third-party merchant offers but
              does not own, operate, or control participating merchants.
              Tailgate does not guarantee that any merchant will honor a
              particular discount or offer at any time. While Tailgate may enter
              into agreements with merchants and encourage compliance, Tailgate
              has no direct control over merchant verification practices,
              point-of-sale systems, employee actions, or business operations.
            </p>

            <p className="text-muted-foreground leading-7">
              Tailgate is not responsible or liable for a merchant&apos;s
              refusal to honor an offer, modification of terms, or
              discontinuation of participation.
            </p>
          </section>

          <section className="space-y-4">
            <h3 className="text-xl font-semibold">9. Data Retention</h3>

            <p className="text-muted-foreground leading-7">
              Tailgate retains personal data for as long as reasonably necessary
              to fulfill the purposes described in this Privacy Policy, unless a
              longer retention period is required or permitted by law.
              Aggregated, anonymized, or derived data may be retained
              indefinitely.
            </p>
          </section>
          ...
          <section className="space-y-4">
            ...
            <p className="text-muted-foreground leading-7">
              Depending on your state of residence, you may have rights
              regarding your personal data, including the right to access,
              correct, delete, or opt out of certain processing or data sharing
              activities. Tailgate provides mechanisms to exercise such rights
              as required by applicable law, including state privacy statutes.
            </p>

            <p className="text-muted-foreground leading-7">
              Requests may require verification of identity and may be denied
              where permitted by law. Rights do not apply to aggregated,
              anonymized, or derived data to the extent permitted by law.
            </p>
          </section>

          <section className="space-y-4">
            <h3 className="text-xl font-semibold">11. Opt-Out Mechanisms</h3>

            <p className="text-muted-foreground leading-7">
              Tailgate provides opt-out mechanisms for marketing communications
              and, where required by law, certain data sharing or targeted
              advertising activities. Opt-out requests may be submitted through
              provided links, account settings, or by contacting Tailgate
              directly. Tailgate will honor valid opt-out requests in accordance
              with applicable law.
            </p>
          </section>

          <section className="space-y-4">
            <h3 className="text-xl font-semibold">12. Data Security</h3>

            <p className="text-muted-foreground leading-7">
              Tailgate implements reasonable administrative, technical, and
              physical safeguards designed to protect information from
              unauthorized access, disclosure, alteration, or destruction.
              However, no system is completely secure, and Tailgate cannot
          ...
          <section className="space-y-4">
            ...
            <p className="text-muted-foreground leading-7">
              ...
              eighteen (18). Tailgate does not knowingly collect personal data
              from minors. If Tailgate becomes aware that it has collected data
              from a minor, it will take reasonable steps to delete such
              information.
            </p>
          </section>
          ...
          <section className="space-y-4">
            ...
            <p className="text-muted-foreground leading-7">
              Tailgate may update this Privacy Policy at any time. Changes
          ...
          <section className="space-y-4">
            <h3 className="text-xl font-semibold">15. Governing Law</h3>

            <p className="text-muted-foreground leading-7">
              This Privacy Policy is governed by the laws of the State of
              Delaware, without regard to conflict-of-law principles, except
              where superseded by applicable state or federal privacy laws.
            </p>
          </section>

          <section className="space-y-4">
            <h3 className="text-xl font-semibold">16. Contact Information</h3>
