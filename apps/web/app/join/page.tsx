...
async function JoinTeamAccountPage(props: JoinTeamAccountPageProps) {
  ...
  // After accepting the invitation, redirect directly to team home.
  // Password setup is handled before reaching this page (via /join/setup-password).
  const nextPath = accountHome;
