...
export default withSentryConfig(nextConfig, {
  org: process.env.SENTRY_ORG ?? 'vizio-ol',
  project: process.env.SENTRY_PROJECT ?? 'vulpecula-nextjs',
  authToken: process.env.SENTRY_AUTH_TOKEN ?? '9518a028029411f19b05fe5751a316b0',
